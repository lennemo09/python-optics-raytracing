...
blue_light = OpticalProperties('blue', blue_light_refractive_index)
indigo_light = OpticalProperties('indigo', indigo_light_refractive_index)
violet_light = OpticalProperties('violet', violet_light_refractive_index)
